(function () {
  window.addEventListener("DOMContentLoaded", () => {
    ...
    async function obtenerDatosServicios() {
      const obtenerServiciosVehicularesParNuevoRegistroURL =
        "/ObtenerServiciosVehicularesParaNuevoRegistro";
      const peticion = await fetch(
        obtenerServiciosVehicularesParNuevoRegistroURL,
        {
          method: "GET",
        }
      );
  ...
  const selectTipoServicioVehicular = document.getElementById(
  ...
  const botonEnviarFormulariRegistroMantenimientoVehiculo =
  ...
  if (botonEnviarFormulariRegistroMantenimientoVehiculo) {
    botonEnviarFormulariRegistroMantenimientoVehiculo.addEventListener(
      "click",
      (e) => {
        e.preventDefault();
    ...
    async function enviarFormulario(inputsFormulario) {
      ...
      const datosFormularioJSON = JSON.stringify(
